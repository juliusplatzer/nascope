#!/usr/bin/env python3
"""
asdex/notams.py — fetch NOTAMs from notams.online, filter for
...
Usage:
    python3 asdex/notams.py KSFO --output -        # stdout (scope consumes this)
    python3 asdex/notams.py KJFK --output kjfk.json # local inspection

Requirements: pip install -r asdex/requirements.txt
"""
